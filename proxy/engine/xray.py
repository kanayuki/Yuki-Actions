...
from core.parse import link_to_xray_outbound
...
class XrayEngine(TestEngine):
    ...
    def _test_chunk(
        ...
        for i, link in enumerate(links):
            ...
            inbounds.append({"tag": socks_tag, "port": socks_port, "listen": "127.0.0.1", "protocol": "socks", "settings": {"auth": "noauth"}})
